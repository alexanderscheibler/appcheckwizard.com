...
export default function Modal({ isOpen, onClose, title, href, imgSrc, imgAlt, tech }: ModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 overflow-y-auto">
          ...
          <p className="text-center text-gray-400 mt-4 text-sm">Made with {tech}.</p>
        </div>
